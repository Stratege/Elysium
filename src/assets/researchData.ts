...
let covenantInternal: TreeNode<{desc : string,
  ...
  { x: dr, y: 1, name: "Divine Right", dependOn: ["Recover the Teachings"], elem: { desc: "", cost: 1, benefit: "Unlock [Scrutators] which can be used to increase production of a single building by 50% (rounded up) and gain 1 Scrutator. "+preachertext}},
